...
[data] = create_dataset(atlas, include_subcortical);
...
function [data] = create_dataset(atlas, include_subcortical)
...
for subject_idx = 1:length(subject_list)
    ...
    [all, at_least_one_of_each, none] = p.which_fcs_exist(atlas, include_subcortical);
